        ...
        <section className="profile-bottom">
          <div className="box">
            <div className="profile-main-grid">
              {investedCard && investedCard.map((card, _index) => (
              <div className="pmg-right-card-nft">
                ...
                <div className="pmg-btn-box-nft">
                  ...
                  <a href={`https://testnets.opensea.io/assets/mumbai/${card.addressDopotReward}/${card.tierId}`} target="_blank" class="grd-btn dopot-btn-lg" rel="noreferrer">
                    <div>Swap</div>
                  </a>
                  <div class="content">
                    <img
