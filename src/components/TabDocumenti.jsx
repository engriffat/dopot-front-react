...
const TabDocumenti = (props) => {
  ...
  const [showPdfs, setShowPdfs] = useState(Array(props.progetto.documentazioneListFiles.length).fill(false));
    ...
    <div className="pc-content-grid-left">
      ...
      {props.progetto.documentazioneListFiles.map((data, i) => {
        ...
        return (
          ...
          >
            <h3><button onClick={() => handleClick(i)}>Document {i+1}</button></h3>
